...
This is faster than using the page() function, because fewer commands are send to the display.
\

In order to draw pixel-by-pixel and not only pages we wrote the drawsprite_px function:
```{.c}
