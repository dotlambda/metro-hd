...
struct Character
{
    ...
    uint8_t damage;
    uint8_t jumpheight;
    enum {FOLLOW_PROTAGONIST, BACK_AND_FORTH, PROJECTILE, HIDDEN, JUMP, JUMPMOVE, FLYING_AROUND, BOMB, ENERGYTANK, XPARASITE, FIREBALL, SECROB, BOSS_DRAGON_GROUND, ARROW, ARROW_UP} movement;
    uint8_t x_pace;
    uint8_t y_pace;
};
