...
struct Character
{
    uint8_t x;
    uint8_t y;
    enum {LOOK_MONSTER_GEEGA, LOOK_MONSTER_MEMU, LOOK_MONSTER_METROID, LOOK_MONSTER_LITTLE, LOOK_EYEMONSTER, LOOK_MONSTER_ZOOMER, LOOK_MONSTER_HORNOAD, LOOK_MONSTER_SIDEHOPPER, LOOK_BOSS_ZAZABI, LOOK_BOSS_DRAGON, LOOK_PROTAGONIST, LOOK_ROCKET, LOOK_BOMB, LOOK_ENERGYTANK} look;
